...
open class SpinWheelControl: UIControl {
    ...
    public var testicles: CGFloat = 0
    ...
    public func drawWheel() {
        ...
        // OKKKKK
        let image = UIImage(named: "tempwheel")
        let imageview = UIImageView(image: image)
        imageview.frame = spinWheelView.frame
        imageview.center = spinWheelView.center
        //imageview.contentMode = UIViewContentMode.scaleAspectFill
        imageview.alpha = 1.0
        imageview.transform = CGAffineTransform(rotationAngle: 90)
        spinWheelView.addSubview(imageview)
    ...
    public func test() {
        ...
        decelerationDisplayLink = CADisplayLink(target: self, selector: #selector(SpinWheelControl.test2))
    ...
    func test2() {
        testicles = testicles + 0.01
        let newVelocity: Velocity = testicles * SpinWheelControl.kDecelerationVelocityMultiplier
        let radiansToRotate: Radians = testicles / CGFloat(SpinWheelControl.kPreferredFramesPerSecond)
